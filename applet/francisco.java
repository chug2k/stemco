...
public class francisco extends PApplet {
...
public PVector getScreenCoords(PVector rawCoords) {
...
public boolean testGetScreenCoords() {
...
*/
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "francisco" });
  }
}
